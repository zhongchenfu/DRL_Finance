...
class MultiFreqFeaturesExtractor(BaseFeaturesExtractor):
    ...
    def __init__(self, observation_space: gym.Space,
        ...
        features_dim = hidden_size * (3 if self.use_high_frequency else 2) + portfolio_features
        ...
        self.high_net = DilatedLSTMStack(high_features, hidden_size) if self.use_high_frequency else None
    ...
    def forward(self, observations: torch.Tensor) -> torch.Tensor:
        ...
        high_size = self.high_len * self.high_feat if self.use_high_frequency else 0
        ...
        if self.use_high_frequency:
            ...
            fused_parts.append(h_high)
        fused_parts.append(portfolio_state)
